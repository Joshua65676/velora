...
const Vault: React.FC = () => {
  return (
    <main className=" bg-VaultBg md:h-[832px]">
      <main className="bg-[url(./assets/vaultBg.svg)] bg-center bg-cover bg-origin-padding container mx-auto md:h-[830px] md:max-w-[1088px]">
